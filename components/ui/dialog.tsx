  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        sm:rounded-xl sm:w-full sm:top-[50%] sm:left-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:grid sm:h-auto sm:max-w-lg sm:data-[state=open]:slide-in-from-top-1/2 sm:data-[state=open]:slide-in-from-left-1/2 sm:data-[state=closed]:slide-out-to-top-1/2`,
        className
      )}
      {...props}
    >
